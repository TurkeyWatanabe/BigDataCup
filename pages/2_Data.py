...
st.markdown("<span style='color:red'>We have kept the Sketch domain as the test set and used data from other domains as the training set. Due to the requirement in the setting of the domain generalization that the test set is unseen, participating teams can only obtain data on the training set. The download link is:</span>", unsafe_allow_html=True)