...
st.markdown("Register your team to participate in the *Challenges of Trustworthy AI in Distribution Shifts and Algorithmic Fairness 2024*. Each team consists of at least one captain and up to five other members. The email of each team leader is used as **the unique identifier** for submission.")

st.markdown("Please complete the following form to register for the team:")
st.markdown("https://docs.google.com/forms/d/e/1FAIpQLSdr6bGZk3OCdWktTZ7zWlDpT0TW5fnOHKA-TGeInQ4CukUF0Q/viewform?usp=sf_link")
